...
const biometricInfoToCheck =
    "برای تنظیم سیستم تشخیص بایومتریک لازم است تا شما دارای فناوری حسگر اثرانگشت (تاچ آی دی) و یا فناوری تشخیص چهره (فیس آی دی) و یا سیستم تشخیص عنبیه چشم باشید در غیر این صورت شما فقط برای ورود به اپلیکیشن خود نیازمند به گذرواژه ای دارید که بعد از این مرحله تنظیم خواهید کرد";
