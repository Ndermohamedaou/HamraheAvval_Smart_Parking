...
// Home <<Slots View>>
// APP bar
const securityAppBarText = "اپليكيشن انتظامات";
...
const passValDsc = "گذرواژه شما باید ترکیبی از حروف بزرگ و کوچک و اعداد باشد";
...
const notFoundDsc = "نتیجه جست و جو خالی است،‌ لطفا جست و جوی دیگری نمایید";
...
const notFoundInfoInBookmarkStorage = "شما آیتم ذخیره شده ای ندارید";
...
const emptyMsgTitle = "فیلد خالی نمی توان پذیرفت";
...
const passInvalidTitle = "گذرواژه جدید شما نامعتبر است";
const passInvalidDsc =
    "لطفا گذرواژه ای معتبر وارد کنید که ترکیبی از حروف بزرگ و کوچک علائم و اعداد باشد";
